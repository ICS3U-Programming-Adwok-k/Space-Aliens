...
def game_scene():
    ...
    # Create the score text object and set its initial properties.
    ...
    # Create a list of lasers for when the player shoots.
    lasers = []
    ...
    # Set the layers for the game. Items show up in order from bottom to top.
